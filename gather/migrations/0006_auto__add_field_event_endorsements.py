...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.endorsements'
        db.add_column('gather_event', 'endorsements',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='events_endorsed', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.endorsements'
        db.delete_column('gather_event', 'endorsements_id')
    ...
    models = {
        ...
        'gather.event': {
            ...
            'endorsements': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'events_endorsed'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
