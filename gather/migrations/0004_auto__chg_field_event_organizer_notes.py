...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.organizer_notes'
        db.alter_column('gather_event', 'organizer_notes', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Event.organizer_notes'
        db.alter_column('gather_event', 'organizer_notes', self.gf('django.db.models.fields.TextField')(default=''))
