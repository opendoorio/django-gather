...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventNotifications.user'
        db.alter_column('gather_eventnotifications', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding unique constraint on 'EventNotifications', fields ['user']
        db.create_unique('gather_eventnotifications', ['user_id'])


        # Changing field 'Event.title'
        db.alter_column('gather_event', 'title', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'Event.slug'
        db.alter_column('gather_event', 'slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=300))

    def backwards(self, orm):
        # Removing unique constraint on 'EventNotifications', fields ['user']
        db.delete_unique('gather_eventnotifications', ['user_id'])


        # Changing field 'EventNotifications.user'
        db.alter_column('gather_eventnotifications', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Event.title'
        db.alter_column('gather_event', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Event.slug'
        db.alter_column('gather_event', 'slug', self.gf('django.db.models.fields.CharField')(max_length=60, unique=True))
    ...
    models = {
        ...
        'gather.event': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '300'}),
