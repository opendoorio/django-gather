...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventAdminGroup.location'
        db.alter_column('gather_eventadmingroup', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Location'], unique=True))
        # Adding unique constraint on 'EventAdminGroup', fields ['location']
        db.create_unique('gather_eventadmingroup', ['location_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EventAdminGroup', fields ['location']
        db.delete_unique('gather_eventadmingroup', ['location_id'])


        # Changing field 'EventAdminGroup.location'
        db.alter_column('gather_eventadmingroup', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Location'], null=True))
    ...
    models = {
        ...
        'gather.eventadmingroup': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Location']", 'unique': 'True'}),
