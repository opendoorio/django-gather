...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventNotifications'
        db.create_table('gather_eventnotifications', (
        ...
        db.send_create_signal('gather', ['EventNotifications'])

        # Adding field 'Event.organizer_notes'
        db.add_column('gather_event', 'organizer_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Event.limit'
        db.add_column('gather_event', 'limit',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Event.private'
        db.add_column('gather_event', 'private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'EventNotifications'
        db.delete_table('gather_eventnotifications')

        # Deleting field 'Event.organizer_notes'
        db.delete_column('gather_event', 'organizer_notes')

        # Deleting field 'Event.limit'
        db.delete_column('gather_event', 'limit')

        # Deleting field 'Event.private'
        db.delete_column('gather_event', 'private')
    ...
    models = {
        ...
        'gather.event': {
            ...
            'organizer_notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
